                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                <thead>
                                    <tr>
                                        <th>#</th><th>Libelle</th><th class="text-center"><i class="fa fa-wrench"></i></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('/admin/categories/' . $item->id) }}" title="View Category"><i class="fa fa-eye" aria-hidden="true"></i> Voir</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('/admin/categories/' . $item->id . '/edit') }}" title="Edit Category"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editer</a>
                                                    </li>
                                                    <li>
