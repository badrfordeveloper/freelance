                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                <tbody>
                                    ...
                                    <tr><th> Description </th><td> {{ $commande->description }} </td></tr><tr><th> Status </th><td> {{ $commande->status }} </td></tr><tr><th> Projet Id </th><td> {{ $commande->projet_id }} </td></tr><tr><th> User Id </th><td> {{ $commande->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
